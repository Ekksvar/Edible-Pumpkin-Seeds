...
public class ItemInit 
{
	...
	{
		event.getRegistry().register(new Item(new Item.Properties().group(Items.PUMPKIN_SEEDS.getGroup()).food(new Food.Builder().hunger(1).fastToEat().build())).setRegistryName(Items.PUMPKIN_SEEDS.getRegistryName()));
